package com.ironhack.monstersofrockserver.security;

import com.ironhack.monstersofrockserver.filter.CustomAuthenticationFilter;
import com.ironhack.monstersofrockserver.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(GET,"/api/festivals/**").permitAll();
        http.authorizeRequests().antMatchers(GET,"/api/bands/**").permitAll();
